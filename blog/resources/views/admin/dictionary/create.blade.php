    ...
    <div class="row">
        <div class="col-lg-12">
            <section class="panel">
                ...
                @endif
                    <div class="form">
                        <form class="cmxform form-horizontal " method="POST" action="{{url('/admin/our-dictionary/store')}}" enctype="multipart/form-data">
                           {{ csrf_field() }}
                            ...
                            <div class="form-group ">
                                ...
                                <div class="col-lg-6">
                                    <input class=" form-control" id="sentence_1" name="sentence_1" type="text" autocomplete="off">
                                </div>
                            </div>
                            <div class="form-group ">
                                <label for="title" class="control-label col-lg-3">Sentence Example 1</label>
                                <div class="col-lg-6">
                                    <input class=" form-control" id="sentence_2" name="sentence_2" type="text" autocomplete="off">
                                </div>
                            </div>
                            <div class="form-group">
